...
silent only
cd ~/source/clients/hackla/engage-client
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/component/Landing.jsx
badd +0 src/component/agenda_item.jsx
badd +0 README.md
badd +0 package.json
badd +0 webpack.config.js
argglobal
silent! argdel *
argadd src/component/Landing.jsx
set stal=2
edit src/component/Landing.jsx
...
let s:l = 7 - ((6 * winheight(0) + 56) / 113)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
7
normal! 032|
tabedit src/component/agenda_item.jsx
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 15 - ((14 * winheight(0) + 56) / 113)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
15
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 17 - ((16 * winheight(0) + 56) / 113)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 13 - ((12 * winheight(0) + 56) / 113)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
13
